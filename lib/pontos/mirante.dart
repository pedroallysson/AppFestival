...
class MirantePage extends StatelessWidget {
        ...
        child: Column(
          ...
          children: [
            ...
            Padding(
              padding: EdgeInsets.symmetric(horizontal: 16),
              child: Text(
                'Um dos mais famosos pontos turísticos de Pedro II, sem dúvida o Mirante do Gritador é o lugar que você não pode deixar de ir quando estiver na cidade serrana. É quase que uma máxima, se foi em Pedro II e não visitou o Mirante, então não foi de fato ao município.\nE claro que ele não poderia faltar aqui em nossas dicas.',
                style: TextStyle(
                  fontSize: 18,
                  color: Colors.grey,
                ),
                    ...
                    Expanded(
                      child: Container(
                        ...
                        child: ElevatedButton.icon(
                          onPressed: () async {
                            const url = 'https://goo.gl/maps/SymyG7yfC11uQces5';
